...
<style>
    ...
    .nama-badge { font-weight: 600; color: var(--text-primary); font-size: 14px; }
    ...
    .form-group input { width: 100%; padding: 10px 14px; border: 1px solid var(--gray-border); border-radius: 8px; font-size: 13px; font-family: inherit; transition: all 0.3s ease; box-sizing: border-box; }
    .form-group input:focus { outline: none; border-color: var(--maroon-main); box-shadow: 0 0 0 3px rgba(165,42,42,0.1); }
...
<div class="dashboard-content">
    ...
    <div class="page-header">
        <div class="page-header-left">
            <h2><i class="fas fa-calendar-alt" style="color:var(--maroon-main); margin-right:8px;"></i>Tahun</h2>
            <p>Kelola data tahun akademik KKA</p>
        </div>
        @if(auth()->user()->hasAccess('tambah.tahun'))
    ...
    @if(!auth()->user()->hasAccess('tambah.tahun') && !auth()->user()->hasAccess('edit.tahun') && !auth()->user()->hasAccess('hapus.tahun'))
    ...
    <div class="table-toolbar">
        <div class="search-box">
            ...
            <input type="text" id="searchInput" placeholder="Cari tahun..." onkeyup="filterTable()">
        </div>
        <div class="table-info">Total: <strong>{{ $tahunList->count() }}</strong> tahun</div>
    </div>
    ...
    <div class="table-container">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Nama</th>
                    <th>Keterangan</th>
                    @if(auth()->user()->hasAccess('edit.tahun') || auth()->user()->hasAccess('hapus.tahun'))
                    <th style="width:120px">Aksi</th>
                    @endif
                </tr>
            </thead>
            <tbody id="tableBody">
                @foreach($tahunList as $index => $item)
                <tr>
                    <td>{{ $index + 1 }}</td>
        ...
        <div class="empty-state">
            ...
            @if(auth()->user()->hasAccess('tambah.tahun'))
                <p>Klik tombol "Tambah Tahun" untuk menambahkan data baru.</p>
            @else
...
<div class="modal-overlay" id="modal-tambah">
    <div class="modal">
        <div class="modal-header">
            <h3><i class="fas fa-plus-circle" style="color:var(--maroon-main); margin-right:8px;"></i>Tambah Tahun</h3>
        ...
        <form action="{{ route('tahun.store') }}" method="POST">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Nama Tahun <span style="color:#ef4444">*</span></label>
...
<div class="modal-overlay" id="modal-edit">
    <div class="modal">
        <div class="modal-header">
            <h3><i class="fas fa-edit" style="color:#f59e0b; margin-right:8px;"></i>Edit Tahun</h3>
        ...
        <form id="form-hapus" method="POST">
            ...
            <div class="modal-body">
                <div class="delete-info">
                    ...
                    <p>Apakah Anda yakin ingin menghapus tahun ini?</p>
...
<script>
    ...
    function openEditModal(id, nama, keterangan) {
        ...
        document.getElementById('form-edit').action = '/tahun/' + id;
        openModal('modal-edit');
    }

    function openDeleteModal(id, nama) {
        document.getElementById('delete-nama').textContent = nama;
        document.getElementById('form-hapus').action = '/tahun/' + id;

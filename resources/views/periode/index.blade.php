...
<div class="dashboard-content">
    ...
    <div class="page-header">
        <div class="page-header-left">
            <h2><i class="fas fa-calendar-check" style="color:var(--maroon-main); margin-right:8px;"></i>Periode</h2>
            <p>Kelola data periode pelaksanaan KKA</p>
        </div>
        @if(auth()->user()->hasAccess('tambah.periode'))
    ...
    @if(!auth()->user()->hasAccess('tambah.periode') && !auth()->user()->hasAccess('edit.periode') && !auth()->user()->hasAccess('hapus.periode'))
    ...
    <div class="table-toolbar">
        <div class="search-box">
            ...
            <input type="text" id="searchInput" placeholder="Cari periode..." onkeyup="filterTable()">
        </div>
        <div class="table-info">Total: <strong>{{ $periodeList->count() }}</strong> periode</div>
    </div>
    ...
    <div class="table-container">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Nama</th>
                    <th>Keterangan</th>
                    @if(auth()->user()->hasAccess('edit.periode') || auth()->user()->hasAccess('hapus.periode'))
                    <th style="width:120px">Aksi</th>
                    @endif
                </tr>
            </thead>
            <tbody id="tableBody">
                @foreach($periodeList as $index => $item)
                <tr>
                    <td>{{ $index + 1 }}</td>
        ...
        <div class="empty-state">
            ...
            @if(auth()->user()->hasAccess('tambah.periode'))
                <p>Klik tombol "Tambah Periode" untuk menambahkan data baru.</p>
            @else
...
<div class="modal-overlay" id="modal-tambah">
    <div class="modal">
        <div class="modal-header">
            <h3><i class="fas fa-plus-circle" style="color:var(--maroon-main); margin-right:8px;"></i>Tambah Periode</h3>
        ...
        <form action="{{ route('periode.store') }}" method="POST">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="nama" placeholder="contoh: Ganjil 2025/2026" required>
                </div>
                <div class="form-group">
...
<div class="modal-overlay" id="modal-edit">
    <div class="modal">
        <div class="modal-header">
            <h3><i class="fas fa-edit" style="color:#f59e0b; margin-right:8px;"></i>Edit Periode</h3>
...
<script>
    ...
    function openDeleteModal(id, nama) {
        ...
        document.getElementById('form-hapus').action = '/periode/' + id;
